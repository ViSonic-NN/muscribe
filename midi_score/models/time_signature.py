...
from ..constants import tsDenoVocabSize, tsNumeVocabSize
...
class RNNTimeSignatureModel(nn.Module):
    def __init__(self, hidden_size=512):
        ...
        self.out_tn = LinearOutput(
            in_features=hidden_size,
            out_features=tsNumeVocabSize,
            activation_type="softmax",
        )
        self.out_td = LinearOutput(
            in_features=hidden_size,
            out_features=tsDenoVocabSize,
            activation_type="softmax",
        )
